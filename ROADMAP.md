...
Status: Milestones 0 through 8 complete; Milestone 9 is in progress. M9 remains unaccepted until the real Codex acceptance matrix passes.
...
- V1 remains unaccepted until the user reviews the final evidence.
